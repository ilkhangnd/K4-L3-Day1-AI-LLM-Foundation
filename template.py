...
def compare_models(prompt: str) -> dict:
    ...
    output_price = PRICING_PER_1K_TOKENS.get("gpt-4o", {}).get("output", 0.010)
    gpt4o_cost_estimate = (len(gpt4o_response.split()) / 0.75) / 1000 * output_price
...
def format_comparison_table(results: list[dict]) -> str:
    ...
    for r in results:
        ...
        g_lat = f"{r.get('gpt4o_latency', 0):.2f}s"
